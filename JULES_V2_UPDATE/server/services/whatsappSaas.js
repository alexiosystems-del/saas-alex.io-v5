    ...
    try {
        ...
        const result = await alexBrain.generateResponse({
            ...
            botConfig: {
                ...
                // Nuevo Default: Nicho Punta de Lanza (High-Ticket/Clínicas)
                system_prompt: config.customPrompt || 'Eres un Concierge Médico Experto. Tu objetivo no es dar diagnósticos, sino pre-calificar al paciente, responder dudas sobre procedimientos usando nuestra base de conocimiento, generar confianza y agendar una cita de valoración. Tono: Profesional, empático, clínico y persuasivo.'
            }
        });
